...
// YOUR EXPLANATION:
// readFile holds the entire file in memory before the application can use it,
// so the memory required grows with the file size. A stream moves the file in
// chunks, keeping peak memory usage roughly flat even when the file is large.
//
